...
<template>
  <div
    ...
    class="drawer flex items-center p-4 bg-white hover:bg-gray-300"
  >
    ...
    <div class="w-16 h-16 bg-primary-50 text-white rounded-lg overflow-hidden">
      <img
        :src="props.item.placeDetailDto.photo ? props.item.placeDetailDto.photo : defaultImg"
        alt=""
  ...
  >
    ...
    <div v-if="selectedPlace.placeDetailDto.photo" class="flex flex-col bg-white">
      ...
      <div class="p-4">
        <h2 class="text-xl font-bold mb-2">{{ selectedPlace.placeDetailDto.name }}</h2>
        ...
        <div name="place_info" v-if="activeTab === 'info'" class="p-4">
          ...
          >
            ...
            >
              <dt class="mb-1 text-sm text-gray-500 md:text-sm dark:text-gray-400">주소</dt>
            ...
            >
              ...
              <dd class="font-semibold">{{ selectedPlace.placeDetailDto.fullAddress }}</dd>
            </div>
            <div
