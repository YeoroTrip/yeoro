...
<!-- drawer component -->
    ...
    <div name="ratingByStars" class="flex items-center mb-3">
        ...
        <p class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400">{{selectedPlace.placeDetailDto.rating}}</p>
    ...
    <div class="border-t border-gray-300">
        <div class="flex justify-around mt-2 ">
            <button @click="activeTab = 'info'" :class="{'text-primary-700': 
            activeTab === 'info'}" 
            ...
            <button @click="activeTab = 'chat'" :class="{'text-primary-700': activeTab === 'chat'}" class="py-2 bg-transparent text-gray-400 hover:text-gray-900 dark:hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div name="place_info" v-if="activeTab === 'info'" class="p-4">
        ...
        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
            ...
            <div v-if="selectedPlace.placeDetailDto.category" class="flex flex-col pb-3  hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
                <dt class="mb-1 text-sm text-gray-500 md:text-lg dark:text-gray-400">주소</dt>
                <dd class="text-lg font-semibold"  id="full-address" >{{ selectedPlace.placeDetailDto.fullAddress }}</dd>
            </div>

            <div class="flex flex-col pb-3  hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
                <dt class="mb-1 text-sm text-gray-500 md:text-lg dark:text-gray-400">주소</dt>
                <dd class="text-lg font-semibold">{{ selectedPlace.placeDetailDto.fullAddress }}</dd>
            </div>
            <div class="flex flex-col py-3 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
            ...
            <div v-if="bPlaceOpeningHour" class="flex flex-col pt-3 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
                ...
                <dd class="text-lg font-semibold"
                    v-for="(day, index)  in selectedPlace.placeDetailDto.placeOpeningHoursDto" 
                        :key="index" :class="{'text-primary-700': index === daysOfWeek[currentDay]}">
                        {{ day }}
                </dd>
            </div>
        </dl>
