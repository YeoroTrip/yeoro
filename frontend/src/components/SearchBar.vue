...
<template>
  <div class="text-center mb-8"> <!-- 부모 요소에 text-center 클래스 추가 -->
    <form class="max-w-md mx-auto mt-8"> <!-- 검색 창 감싸는 div에 mx-auto 클래스 추가 -->
