...
import PopupModalComponent from '@/components/PopupComponent.vue'
     ...
     <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p v-if="isLoginError === true" class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-normal"> 
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  <div>
                      ...
                      <input 
                      v-model="user.userId"
                      type="text" name="userid" id="userid" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="아이디를 입력해주세요!" required="true">
                  </div>
                  <div>
                  ...
                  <!-- </div> -->
                  <button @click.prevent="login" type="submit" class="w-full text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-extrabold rounded-lg text-sm px-5 py-2.5 text-center
                                                                dark:bg-primary-700 dark:hover:bg-primary-700 dark:focus:ring-primary-800">로그인</button>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      계정이 없으신가요? 🧚 <RouterLink to="Join" class="font-medium text-primary-900 hover:underline dark:text-primary-500">가입하기</RouterLink>
                  </p>
